...
class _FurnitureDetailScreenState extends State<FurnitureDetailScreen> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      "Minimalist Velvet Sofa - 3 Seater".text.xl.bold.make(),
                      const SizedBox(height: 16),
                      Row(
                        children: [
                          const Icon(Icons.location_on_outlined, size: 16, color: Colors.grey),
                          const SizedBox(width: 4),
                          "Furniture Row, Decor Plaza, Kashipur, Uttarakhand..".text.gray500.size(12).ellipsis.make().expand(),
                        ],
                      ),
                      const Divider(height: 32),
                      "Premium Velvet | Solid Wood Frame | 2 Year Warranty".text.bold.size(13).make(),
                      ...
                      "Upgrade your living space with this minimalist velvet sofa. Crafted with a solid wood frame and high-density foam, it provides both style and comfort."
  ...
  Widget _buildPriceSection() {
    return Row(
      children: [
        "₹ 45,000".text.xl3.bold.red600.make(),
  ...
  Widget _buildSpecsTable() {
    final specs = [
      {"label": "Dimensions", "value": "200 x 90 x 85 cm"},
  ...
  Widget _buildAmenities() {
    final List<Map<String, dynamic>> allAmenities = [
      ...
      {"icon": Icons.verified_outlined, "label": "2 Year Warranty"},
      {"icon": Icons.local_shipping_outlined, "label": "Free Delivery"},
      {"icon": Icons.chair_outlined, "label": "Ergonomic"},
      {"icon": Icons.brush_outlined, "label": "Hand Crafted"},
      {"icon": Icons.home_repair_service_outlined, "label": "Assembly"},
      {"icon": Icons.event_available_outlined, "label": "Ready Stock"},
    ];
  ...
  Widget _buildMapView() {
    return Column(
      ...
      children: [
        ...
        ClipRRect(
          ...
          child: Container(
            ...
            child: GoogleMap(
              ...
              markers: {
                Marker(
                  markerId: const MarkerId("furniture_location"),
        ...
        const SizedBox(height: 12),
        "Furniture Row, Decor Plaza, Kashipur, Uttarakhand 244713, India".text.gray600.size(12).make(),
      ],
    );
  }
  ...
  Widget _buildSellerCard() {
    return Column(
      children: [
        ...
        const SizedBox(height: 12),
        "Elite Interiors".text.bold.size(16).center.make(),
        "Premium Furniture Dealer".text.gray500.size(14).make(),
        const SizedBox(height: 8),
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            "Member Since from February 2024".text.gray600.size(12).make(),
            const SizedBox(width: 4),
