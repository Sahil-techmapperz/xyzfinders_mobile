...
class FurnitureListScreen extends StatefulWidget {
  ...
  const FurnitureListScreen({super.key, this.categoryId});
            ...
            Expanded(
              child: _isLoading 
                ...
                : _error != null 
                  ...
                  : _products.isEmpty
                    ? Center(child: "No furniture found".text.make())
                    : ListView.builder(
  ...
  Widget _buildProductCard(BuildContext context, ProductModel item) {
    ...
    return Container(
      ...
      child: Column(
                ...
                child: item.firstImageUrl != null
                  ? CachedNetworkImage(
                      ...
                      errorWidget: (context, url, error) => Container(
                        ...
                        width: double.infinity,
                        child: const Icon(Icons.chair, color: Colors.grey, size: 50).centered(),
                      ),
                    )
                  : Container(
                      height: 220,
       ...
       Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => FurnitureDetailScreen(
            productId: item.id,
            title: item.title,
          )),
        );
