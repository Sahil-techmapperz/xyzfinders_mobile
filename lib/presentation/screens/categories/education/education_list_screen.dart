...
class _EducationListScreenState extends State<EducationListScreen> {
  ...
  void _showLevelFilter() {
    showModalBottomSheet(
      ...
      builder: (context) => FilterBottomSheet(
        title: "Select Level",
        options: const ["School", "College", "Professional", "Other"],
    ...
    return Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildFilterChip(null, _selectedLevel ?? "Level", hasDropdown: true).onTap(() => _showLevelFilter()),
  ...
  Widget _buildFilterChip(IconData? icon, String label, {bool hasDropdown = false, bool isIconOnly = false}) {
    bool isActive = label != "Level" && label != "Price" && !isIconOnly;
